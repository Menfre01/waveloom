...
<p align="center">
  ...
  <a href="https://github.com/Menfre01/waveloom/releases"><img src="https://img.shields.io/github/downloads/Menfre01/waveloom/total?style=flat-square&color=00ADD8&label=downloads&labelColor=161b22" alt="downloads"/></a>
...
| Document | Content |
|----------|---------|
| [`usage`](./usage.en.md) | Interactive mode, shortcuts, Skill system |
| [`install`](./install.en.md) | Homebrew / curl / source / shell completions |
| [`settings`](./settings.en.md) | API key, model, timeout, compaction |
| [`prefix-cache`](./prefix-cache.en.md) | DeepSeek caching, four-tier compaction |
| [`environment`](./environment.en.md) | LSP server, toolchain probing |
