...
| `--verbose` | 输出详细日志到 `.waveloom/wvl.log` | 关闭 |
...
| 恢复会话 | `wvl --continue` 恢复最近会话，`wvl --resume <id>` 恢复指定会话，`wvl ls` 列出可选 ID |
