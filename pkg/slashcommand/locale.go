...
// NewLocaleCommand 构造 /locale 命令（零依赖）。
func NewLocaleCommand() *LocaleCommand { return &LocaleCommand{} }

// Name 返回命令名。
func (c *LocaleCommand) Name() string { return "locale" }

// Description 返回命令说明。
func (c *LocaleCommand) Description() string { return "Switch language (zh-CN / en-US)" }
