...
// NewThemeCommand 构造 /theme 命令。
func NewThemeCommand(messages *SlashMessages) *ThemeCommand {
	return &ThemeCommand{messages: messages}
}
...
// Description 返回命令说明。
func (c *ThemeCommand) Description() string { return c.messages.ThemeDescription }
